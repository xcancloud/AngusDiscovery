  ...
  static class CloudJacksonCodec extends EurekaJacksonCodec {
    ...
    CloudJacksonCodec() {
      ...
      module.addSerializer(Applications.class,
          new EurekaJacksonCodec.ApplicationsSerializer(this.getVersionDeltaKey(),
              this.getAppHashCodeKey()));
      module.addSerializer(InstanceRegistry.class, new InstanceRegistrySerializer());

      module.addDeserializer(LeaseInfo.class, new EurekaJacksonCodec.LeaseInfoDeserializer());
      ...
      module.addDeserializer(Application.class,
          new EurekaJacksonCodec.ApplicationDeserializer(mapper));
      module.addDeserializer(Applications.class,
          new EurekaJacksonCodec.ApplicationsDeserializer(mapper, this.getVersionDeltaKey(),
              this.getAppHashCodeKey()));
